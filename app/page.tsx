      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="max-w-xl">
          <p className="text-[#6153CC] mb-4 flex items-center gap-2 font-bold"> 
            <Image src="/images/Sparkling.svg" alt="sparkling" width={20} height={20}></Image>
            Mint is paused
          </p>
          ...
          <div className="flex gap-4 mb-12">
            ...
            <div className="flex items-center">
              <Image src = '/images/Item.png' alt="item no gas" width={140} height={100}></Image>
            </div>
          </div>
          
          <div className="flex items-center gap-2">
            <Image src = '/images/Minted.svg' alt="minted people" width={280} height={40}></Image>
          </div>
        </div>
        ...
        <div className="relative">
          <Image
            ...
            width={1800}
            height={600}
            className="relative z-10 w-[200rem]"
          />
        </div>
      </div>
    </main>
